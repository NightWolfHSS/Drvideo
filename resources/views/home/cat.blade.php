...
<head>
	...
	{{-- Site Title --}}
	<title>shop.megacampro.kz - весь ассортимент товаров</title>
	{{-- ===CSS ============================================= --}}
		...
		<div class="row">
			...
			<div class="col-xl-9 col-lg-8 col-md-7">
				...
				<section class="lattest-product-area pb-40 category-list">
						<div class="filters_name"><h4>фильтр: {{ $fix }}</h4></div>
					<div class="row">
					@if($itm !== null)	
					{{-- output data --}}
					@foreach ($itm as $elem) 
				...
				<div class="filter-bar d-flex flex-wrap align-items-center">
					...
					@if($itm !== null)
						{{ $itm->links('custom') }} {{-- pagination here --}}
					@endif
				</div>
				<!-- End Filter Bar -->
			</div>
